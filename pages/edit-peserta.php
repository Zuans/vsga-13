...
<body>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="../index.php">Calon Peserta</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="./tambah-peserta.php">Daftar Siswa</a>
        </li>
      </ul>
    </div>
  </div>
...
<form action="" method="POST">
  <div class="mb-3">
    ...
    <input type="text" class="form-control" value=""  name="nama" id="input-nama" aria-describedby="input-nama">
  </div>
  <div class="mb-3">
  ...
  <div class="mt-3 mb-3">
    ...
    <input type="text" class="form-control" name="sekolah_asal" id="sekolah-asal" value="" aria-describedby="sekolah-asal">
  </div>
  <div class="d-flex">
